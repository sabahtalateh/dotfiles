...
Установим 2 плагина, для подсветки синтаксиса в терминале и для подсказывания недавно использованных команд. Эти плагины будут пока только установлены, подключим их далее
