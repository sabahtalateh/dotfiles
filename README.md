...
Если не установится из терминала, можно скачать `.pkg` установщик, эта опция тоже есть на главной странице
...
:warning: Чтобы `brew` **был доступен из терминала**, после установки необходимо выполнить действия, перечисленные в терминале, или на последнем шаге установщика.
