...
Нажимаем правой кнопкой в верхней части браузера и убираем всё лишнее. Ненужные элементы можно удалять с тулбара а нужные добалять (но там особо ничего не нужно, кроме кнопки перезагрузки страницы)
